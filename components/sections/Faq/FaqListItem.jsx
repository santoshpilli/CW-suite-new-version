...
//         className={` bg cursor-pointer overflow-hidden  rounded-[4px] ${id === view ? "bg-white" : "bg-white"
//           }`}
//       >
//         <div className="">
//           <div
...
//             className={`${id === view ? "bg-white text-white" : "text-blueshade1"
//               }  font-normal ff-Inter flex items-center justify-between sm:text-md px-4 sm:px-6 py-3 sm:py-4 rounded-[4px]`}
//           >
//             {item.questions}

//             <svg
//               className={`${id === view ? "rotate-180 fill-[#101828]" : "fill-[#101828]"
