...
//   return (
//     <div className={`3xl:h-[768px] bg-center 2xl:bg-left bg-no-repeat bg-cover sm:h-[690px] h-[90vh]`} style={{
//       backgroundImage: `url("${data?.props?.backgroundImage}")`, backgroundColor: data?.styling?.backgroundColor
//     }} >
